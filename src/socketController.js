...
const socketController = (socket, io) => {
  ...
  socket.on("wristPositionR", wristR => {
    if (movementStart) {
      const vertMotion = sideMovement - wristR.side_Y;
      const HoriMotion = topMovement - wristR.top_Y;
      ...
      sideMovement = wristR.side_Y;
      topMovement = wristR.top_Y;

      movementStart = false;
    }
  });

  socket.on("wristPositionL", wristL => {
    if (movementStart) {
      const vertMotion = sideMovement - wristL.side_Y;
      const HoriMotion = topMovement - wristL.top_Y;
      ...
      sideMovement = wristL.side_Y;
      topMovement = wristL.top_Y;
    ...
    if (detections.length > 0) {
      ...
      if (detectionCounter === 0) {
        ...
        if (faceSize < maxHeight * 0.5) {
          ...
          cameraPort.write("Z");
        } else if (faceSize > maxHeight * 0.6) {
          cameraPort.write("O");
          setTimeout(() => {
            cameraPort.write("Z");
          }, 150);
